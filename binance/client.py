...
class Client(BaseClient):
    ...
    def _handle_response(response: requests.Response):
        ...
        # Handle non-success status codes with structured error info when possible
        if not (200 <= response.status_code < 300):
            code = None
            message = None
            if isinstance(parsed, dict):
                # common Binance error shapes
            ...
            # Compose a clear message including extracted code when available
            composed_message = message if message is not None else ""
            if code is not None:
                composed_message = f"{composed_message} (code: {code})"

            raise BinanceAPIException(response, response.status_code, composed_message)

        # Success responses
        if response.text == "":
            return {}

        # If parsed JSON was invalid or None, raise a request exception to avoid
        # propagating None values downstream
        if parsed is None:
    ...
    def margin_v1_get_sol_staking_account(self, **params):
        ...
        """
        return self._request_margin_api(
            "get", "sol-staking/account", signed=True, params=params, version=1
        )
    ...
    def margin_v1_get_account_info(self, **params):
        ...
        """
        return self._request_margin_api(
            "get", "account/info", signed=True, params=params, version=1
        )
    ...
    def options_v1_delete_all_open_orders_by_underlying(self, **params):
        ...
        """
        return self._request_options_api(
            "delete", "allOpenOrdersByUnderlying", signed=True, params=params
        )
    ...
    def margin_v1_get_algo_spot_historical_orders(self, **params):
        ...
        """
        return self._request_margin_api(
            "get", "algo/spot/historicalOrders", signed=True, params=params, version=1
        )
    ...
    def margin_v1_get_loan_vip_repay_history(self, **params):
        ...
        """
        return self._request_margin_api(
            "get", "loan/vip/repay/history", signed=True, params=params, version=1
        )
    ...
    def margin_v1_get_loan_borrow_history(self, **params):
        ...
        """
        return self._request_margin_api(
            "get", "loan/borrow/history", signed=True, params=params, version=1
        )
    ...
    def futures_v1_get_trade_asyn_id(self, **params):
        ...
        """
        return self._request_futures_api(
            "get", "trade/asyn/id", signed=True, params=params, version=1
        )
    ...
    def margin_v1_get_copy_trading_futures_user_status(self, **params):
        ...
        return self._request_margin_api(
            "get",
            "copyTrading/futures/userStatus",
            signed=True,
            params=params,
            version=1,
        )
    ...
    def options_v1_get_margin_account(self, **params):
        ...
        """
        return self._request_options_api(
            "get", "marginAccount", signed=True, params=params
        )
    ...
    def options_get_market_maker_protection_config(self, **params):
        ...
        :type recvWindow: int
        """
        return self._request_options_api("get", "mmp", signed=True, params=params)
    ...
    def margin_v1_get_asset_wallet_balance(self, **params):
        ...
        """
        return self._request_margin_api(
            "get", "asset/wallet/balance", signed=True, params=params, version=1
        )
    ...
    def margin_v1_get_broker_universal_transfer(self, **params):
        ...
        """
        return self._request_margin_api(
            "get", "broker/universalTransfer", signed=True, params=params, version=1
        )
    ...
    def margin_v1_get_loan_collateral_data(self, **params):
        ...
        """
        return self._request_margin_api(
            "get", "loan/collateral/data", signed=True, params=params, version=1
        )
    ...
    def margin_v1_get_loan_repay_history(self, **params):
        ...
        """
        return self._request_margin_api(
            "get", "loan/repay/history", signed=True, params=params, version=1
        )
